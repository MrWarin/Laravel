      ...
      <form id="FilterForm" method="get">
        <div class="row">
          ...
          <div class="col-12">
            ...
            <a href="/shipping/create/"><button type="button" class="btn btn-primary"><i class="fas fa-plus-circle"></i></button></a>
      ...
      <div id="table">
        <table>
          ...
          <tr class="{{ ($i % 2 == 0)?'odd':'' }}">
            ...
            <td class="text-right">
              <a href="/shipping/{{ $shipping->id }}/edit/"><button class="btn btn-success" title="แก้ไข"><i class="fa fa-edit"></i></button></a>
              <form class="d-inline-block" action="/shipping/{{ $shipping->id }}/" method="post">
                @method('DELETE')
                @csrf
